...
function Reviews() {
  ...
  const handlers = useSwipeable({
    onSwipedLeft: () => frontBtnClick(),
    onSwipedRight: () => backBtnClick(),
    preventDefaultTouchmoveEvent: true,
    trackMouse: true, 
  });

  return (
    <div className="review-section" id="reviews" {...handlers}>
      <div className="rw-text-content">
        <p className="rw-text-title">
          More than <span className="rw-text-num">2000+ Patients</span>
        </p>
